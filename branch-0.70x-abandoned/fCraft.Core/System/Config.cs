...
namespace fCraft {
    public static class Config {
        ...
        static void ReadPlayerDBSettings( JsonObject obj ) {
            ...
            JsonObject mySqlSettings = null;
            if( obj.Has( "MySqlSettings" ) && !obj.TryGetObject( "MySqlSettings", out mySqlSettings ) ) {
                Logger.Log( LogType.Error,
                            "Config.Load: Could not parse MySQL PlayerDB engine settings." );
            }
            PlayerDB.MySqlProviderSettings = mySqlSettings;

            JsonObject flatfileSettings = null;
            if( obj.Has( "FlatfileSettings" ) && !obj.TryGetObject( "FlatfileSettings", out flatfileSettings ) ) {
                Logger.Log( LogType.Error,
                            "Config.Load: Could not parse MySQL PlayerDB engine settings." );
            }
            PlayerDB.FlatfileProviderSettings = flatfileSettings;
        }
