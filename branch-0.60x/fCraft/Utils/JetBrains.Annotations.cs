...
namespace JetBrains.Annotations {
    ...
    /// The format string should be in <see cref="string.Format(IFormatProvider,string,object[])"/>-like form </summary>
    ...
    /// of the caller function. For example, ReSharper annotates the parameter of <see cref="System.ArgumentNullException"/>. </summary>
    ...
    /// <summary> Specify what is considered used implicitly when marked with
    ...
    /// The same as System.Diagnostics.Contracts.PureAttribute. </summary>
