...
namespace fCraft.Drawing {
    ...
    public sealed class CuboidWireframeDrawOperation : DrawOperation {
        ...
        IEnumerable<Vector3I> BlockEnumerator() {
            ...
            if( Bounds.XMin != Bounds.XMax && Bounds.YMin != Bounds.YMax ) yield return new Vector3I( Bounds.XMax, Bounds.YMax, Bounds.ZMin );
            if( Bounds.YMin != Bounds.YMax && Bounds.ZMin != Bounds.ZMax ) yield return new Vector3I( Bounds.XMin, Bounds.YMax, Bounds.ZMax );
            if( Bounds.ZMin != Bounds.ZMax && Bounds.XMin != Bounds.XMax ) yield return new Vector3I( Bounds.XMax, Bounds.YMin, Bounds.ZMax );

            if( Bounds.XMin != Bounds.XMax && Bounds.YMin != Bounds.YMax && Bounds.ZMin != Bounds.ZMax ) yield return new Vector3I( Bounds.XMax, Bounds.YMax, Bounds.ZMax );
