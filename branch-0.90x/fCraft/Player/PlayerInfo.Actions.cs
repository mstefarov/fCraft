    ...
    public sealed partial class PlayerInfo {
        ...
        void BanPlayerInfoInternal( [NotNull] Player player, [CanBeNull] string reason,
            ...
            lock( actionLock ) {
                ...
                PlayerInfoBanChangingEventArgs e = new PlayerInfoBanChangingEventArgs( this,
                                                                                       player,
                                                                                       unban,
                                                                                       reason,
                                                                                       announce );
        ...
        public void BanIP( [NotNull] Player player, [CanBeNull] string reason, bool announce, bool raiseEvents ) {
            ...
            lock( actionLock ) {
                ...
                PlayerInfo infoWhomPlayerCantBan = PlayerDB.FindPlayers( address )
                                                           .FirstOrDefault(
                                                               info => !player.Can( Permission.Ban, info.Rank ) );
                ...
                if( !needIPBan && !needNameBan ) {
                    ...
                    if( player.Can( Permission.ViewPlayerIPs ) ) {
                        ...
                        colorMsg = String.Format(
                            "&SGiven player ({0}&S) and their IP address are both already banned.",
                            ClassyName );
                    }
        ...
        public void BanAll( [NotNull] Player player, [CanBeNull] string reason, bool announce, bool raiseEvents ) {
            ...
            lock( actionLock ) {
                ...
                foreach( PlayerInfo targetAlt in allPlayersOnIP ) {
                    ...
                    // Raise PlayerInfo.BanChanging event
                    PlayerInfoBanChangingEventArgs e = new PlayerInfoBanChangingEventArgs( targetAlt,
                                                                                           player,
                                                                                           false,
                                                                                           reason,
                                                                                           announce );
        ...
        public void Freeze( [NotNull] Player player, FreezeOptions options ) {
            ...
            lock( actionLock ) {
                ...
                if( IsFrozen ) {
                    ...
                    string colorMsg = String.Format( "&SPlayer {0}&S is already frozen (by {1}&S).",
                                                     ClassyName,
                                                     FrozenByClassy );
                    throw new PlayerOpException( player, this, PlayerOpExceptionCode.NoActionNeeded, msg, colorMsg );
                }
