...
namespace fCraft {
    ...
    public sealed class PlayerOpException : Exception {
        ...
        internal static void ThrowNoOneToBan( [NotNull] Player player, [CanBeNull] PlayerInfo targetInfo,
            ...
            if( targetInfo == null ) {
                ...
                if( player.Can( Permission.ViewPlayerIPs ) ) {
                    msg =
                        String.Format(
                            "Player {0}, their IP ({1}), and all players who use this IP are already banned.",
                            targetInfo.Name,
                            address );
                    colorMsg =
                        String.Format(
        ...
        internal static void ThrowInvalidIP( [NotNull] Player player, [CanBeNull] PlayerInfo target,
            ...
            throw new PlayerOpException( player, target, PlayerOpExceptionCode.InvalidIP, msg, msgColored );
        }
    }
