    ...
    static class ZoneCommands {
        ...
        static void ZoneAddHandler( Player player, CommandReader cmd ) {
            ...
            if( givenZoneName.StartsWith( "+" ) ) {
                ...
                PlayerInfo info = PlayerDB.FindPlayerInfoOrPrintMatches( player, givenZoneName, true );
                if( info == null ) return;
                ...
                while( ( name = cmd.Next() ) != null ) {
                    ...
                    PlayerInfo info = PlayerDB.FindPlayerInfoOrPrintMatches( player, name.Substring( 1 ), true );
                    if( info == null ) return;
